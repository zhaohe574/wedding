 ...
 * @returns 是否符合标准
 */
export function checkTouchTargetSize(width: number, height: number, minSize = 88): boolean {
 ...
 * @returns 焦点样式对象
 */
export function generateFocusStyle(color = '#0B0B0B'): Record<string, string> {
    return {
