...
const LEGACY_LINK_MAP: Record<string, string> = {
    ...
    '/pages/coupon/list': '/packages/pages/coupon/list',
    '/pages/coupon/center': '/packages/pages/coupon/center',
    '/pages/coupon/detail': '/packages/pages/coupon/detail',
    ...
    '/pages/order_change/apply_transfer': '/packages/pages/order_change/apply_transfer',
    '/pages/order_change/apply_pause': '/packages/pages/order_change/apply_pause',
    '/pages/order_change/transfer_detail': '/packages/pages/order_change/transfer_detail',
    ...
    '/pages/order_change/apply_staff': '/packages/pages/order_change/apply_staff',
