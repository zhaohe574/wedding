...
class OrderConfirmLetterService
{
    ...
    public static function saveAssets(int $letterId, string $snapshotHash, string $fullImageUrl, string $thumbImageUrl): void
    {
        Db::transaction(function () use ($letterId, $snapshotHash, $fullImageUrl, $thumbImageUrl) {
