...
class SalesAdvisorValidate extends BaseValidate
{
    ...
    protected $message = [
        ...
        'wechat.max' => '微信号最多50个字符',
        'wecom_userid.max' => '企微成员ID最多64个字符',
        'contact_qr_code.max' => '联系二维码最多255个字符',
        'contact_link.max' => '联系链接最多255个字符',
     ...
     */
    protected $scene = [
        'add' => ['admin_id', 'advisor_name', 'avatar', 'mobile', 'wechat', 'wecom_userid', 'contact_qr_code', 'contact_link', 'email', 'max_customer_count', 'status', 'sort'],
        'edit' => ['id', 'admin_id', 'advisor_name', 'avatar', 'mobile', 'wechat', 'wecom_userid', 'contact_qr_code', 'contact_link', 'email', 'max_customer_count', 'status', 'sort'],
        'detail' => ['id'],
        'delete' => ['id'],
        'status' => ['id', 'status'],
        'sync' => ['id'],
