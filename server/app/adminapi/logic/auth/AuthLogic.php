    ...
    private static function exactPermissionAliasMap(): array
    {
        return [
            'staff.staff/lists' => [
                ...
                'staff.staff/myProfileAddonList',
                'staff.staff/myProfileAddonAdd',
                'staff.staff/myProfileAddonUpdate',
                'staff.staff/myProfileAddonDelete',
                ...
                'staff.staff/myCoupleQuestionnaireConfig',
                'staff.staff/myCoupleQuestionnaireSave',
                'staff.staff/myCoupleQuestionnairePublish',
                'staff.staff/myCoupleQuestionnaireTasks',
                'staff.staff/myCoupleQuestionnaireTaskDetail',
                'staff.staff/myCoupleQuestionnaireSend',
                'staff.staffWork/lists',
                'staff.staffWork/detail',
                'staff.staffWork/add',
                'staff.staffWork/edit',
                'staff.staffWork/delete',
                'staff.staffWork/batchDelete',
                'staff.staffWork/changeStatus',
                'staff.staffWork/setCover',
                'staff.staffWork/batchAudit',
                'staff.staffCertificate/lists',
                'staff.staffCertificate/detail',
                'staff.staffCertificate/add',
                'staff.staffCertificate/edit',
                'staff.staffCertificate/delete',
                'staff.staffCertificate/batchDelete',
                'staff.staffCertificate/batchAudit',
                'ops.staff/myProfile',
