...
export function staffLists(params?: any) {
    return request.get({ url: '/ops.staff/lists', params })
}

// 工作人员详情
export function staffDetail(params: any) {
    return request.get({ url: '/ops.staff/detail', params })
}

// 添加工作人员
export function staffAdd(params: any) {
    return request.post({ url: '/ops.staff/add', params })
}

// 编辑工作人员
export function staffEdit(params: any) {
    return request.post({ url: '/ops.staff/edit', params })
}

// 删除工作人员
export function staffDelete(params: any) {
    return request.post({ url: '/ops.staff/delete', params })
}

// 修改工作人员状态
export function staffChangeStatus(params: any) {
    return request.post({ url: '/ops.staff/changeStatus', params })
}
...
export function staffResetAdminPassword(params: { id: number }) {
    return request.post({ url: '/ops.staff/resetAdminPassword', params })
}
...
export function staffConfigurePackages(params: any) {
    return request.post({ url: '/ops.staff/configurePackages', params })
}

// 获取员工套餐配置
export function staffGetPackageConfig(params: any) {
    return request.get({ url: '/ops.staff/getPackageConfig', params })
}

// 创建员工专属套餐
export function staffCreatePackage(params: any) {
    return request.post({ url: '/ops.staff/createStaffPackage', params })
}

// 编辑员工专属套餐
export function staffUpdateStaffPackage(params: any) {
    return request.post({ url: '/ops.staff/updateStaffPackage', params })
}

// 更新单个套餐配置
export function staffUpdatePackageConfig(params: any) {
    return request.post({ url: '/ops.staff/updatePackageConfig', params })
}
...
// 编辑员工附加服务
export function staffUpdateStaffAddon(params: any) {
...
export function staffWorkAdd(params: any) {
    return request.post({ url: '/ops.staffWork/add', params })
}

// 编辑作品
export function staffWorkEdit(params: any) {
    return request.post({ url: '/ops.staffWork/edit', params })
}
...
export function staffWorkSetCover(params: any) {
    return request.post({ url: '/ops.staffWork/setCover', params })
}
...
export function staffCertificateAdd(params: any) {
    return request.post({ url: '/ops.staffCertificate/add', params })
}

// 编辑证书
export function staffCertificateEdit(params: any) {
    return request.post({ url: '/ops.staffCertificate/edit', params })
}
...
export function staffBannerList(params: any) {
    return request.get({ url: '/ops.staff/getBannerList', params })
}

// 添加轮播图
export function staffBannerAdd(params: any) {
    return request.post({ url: '/ops.staff/addBanner', params })
}

// 编辑轮播图
export function staffBannerEdit(params: any) {
    return request.post({ url: '/ops.staff/editBanner', params })
}

// 删除轮播图
export function staffBannerDelete(params: any) {
    return request.post({ url: '/ops.staff/deleteBanner', params })
}

// 更新轮播图排序
export function staffBannerSort(params: any) {
    return request.post({ url: '/ops.staff/sortBanner', params })
}
